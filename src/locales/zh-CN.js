export default {
  ...
  "feedback.saved-to-your-library": "已收藏到音乐库",
  "feedback.removed-from-your-library": "已从音乐库中删除",
  "feedback.added-to-your-liked-songs": "已添加至“已点赞的歌曲”",
  "feedback.added-to-your-episodes": "已添加到“你的单集”",
  "feedback.removed-from-your-liked-songs": "已从“已点赞的歌曲”中删除",
  "feedback.removed-from-your-episodes": "已从“你的单集”中删除",
  "web-player.enhance.feedback.recommended_songs_added":
    "已升级至高级版，更新了 {0} 首推荐歌曲。",
  "web-player.enhance.feedback.added_recommendation_to_playlist":
    "已加入歌单。",
  "web-player.enhance.feedback.something_went_wrong": "出错了，再试一次",
  "web-player.enhance.feedback.removed_recommendation": "精选推荐已删除",
  "web-player.enhance.feedback.enhance_playlist_not_possible_offline":
    "To Enhance this playlist, you’ll need to go online.",
  "feedback.exclude-playlist-from-recommendations":
    "此歌单不会影响你的收听动态、喜好总结或精选推荐。",
  "feedback.include-playlist-in-recommendations":
    "此歌单会影响你的收听动态、喜好总结或精选推荐。",
  "feedback.link-copied": "已将链接复制至剪贴板",
  "error.playback": "播放时出错。",
  "feedback.unable-to-play": "无法获取此内容。",
  "pwa.confirm": "欢迎来到你的 Spotify 世界",
  "feedback.radio.ban-track":
    "Got it. We won't play that song in this station.",
  "feedback.format-list-ban-artist":
    "Got it. From now on we won’t put {0} in {1}.",
  "feedback.format-list-ban-track":
    "好的。下一次，我们不会在 {1} 中推荐此类歌曲。",
  ...
  "feedback.employee-podcast-access":
    "You now have access to employee only content.",
  "error.not_found.body": "搜索其他内容？",
  "shared.library.entity-row.liked-songs.title": "Liked Songs",
  "shared.library.entity-row.your-episodes.title": "Your Episodes",
  "shared.library.entity-row.local-files.title": "Local Files",
  "action-trigger.enjoy-library": "享受音乐库中的歌曲",
  "action-trigger.login-library":
    "登录后在音乐库中查看已收藏的歌曲、播客、艺人和歌单。",
  ...
  "action-trigger.liked-songs": "欣赏你已点赞的歌曲",
  "action-trigger.login-liked-songs":
    "登录后，在一个便捷的歌单内便可查看所有你已点赞的歌曲。",
  ...
  "shared.library.sort-by.custom": "Custom order",
  "shared.library.sort-by.name": "Alphabetical",
  "shared.library.sort-by.recently-added": "Recently added",
  "shared.library.sort-by.recently-played": "Recently played",
  "shared.library.sort-by.recently-played-or-added": "Most recent",
  "shared.library.sort-by.recently-updated": "Recently updated",
  "shared.library.sort-by.relevance": "Most relevant",
  "shared.library.filter.album": "Albums",
  "shared.library.filter.artist": "Artists",
  "shared.library.filter.playlist": "Playlists",
  "shared.library.filter.show": "Podcasts & Shows",
  "shared.library.filter.book": "Audiobooks",
  "shared.library.filter.downloaded": "Downloaded",
  "shared.library.filter.by-you": "By you",
  "shared.library.filter.by-spotify": "By Spotify",
  "shared.library.filter.unplayed": "Unplayed",
  "feedback.cant-play-track": "无法播放当前歌曲。",
  "feedback.track-not-available-forced-offline":
    "请关闭离线模式，然后再试一次。",
  "feedback.cant-offline-sync-playlist-in-offline-mode":
    "请关闭离线模式进行下载。",
  "feedback.artist-banned-by-user":
    "只有当你在 Spotify 手机应用中允许播放此艺人的作品后，我们才能播放此内容。",
  "feedback.track-banned-by-user":
    "只有当你在 Spotify 手机应用中允许播放此曲目后，我们才能播放此内容。",
  "feedback.track-not-available-in-region":
    "Spotify 无法在你所在的地区播放此曲目。如果你拥有此内容的本地文件，可进行导入。",
  "feedback.track-not-available":
    "Spotify 当前无法播放此内容。如果你拥有此内容的本地文件，可进行导入。",
  "feedback.video-playback-network-error":
    "Network connection failed while playing this content.",
  ...
  "feedback.skip-ads-to-hear-song":
    "将在广告结束后播放你的曲目。跳过广告，更快地回到你当前播放的音乐吧！",
  "feedback.skip-ads-after-delay":
    "你可在 {0} 秒后跳过广告，回到你当前播放的内容。",
  "capping.upsell-title": "你的免费收听时长已到期。",
  "feedback.video-georestricted":
    "We're not able to play this content in your current location.",
  "feedback.video-unsupported-client-version":
    "Please upgrade Spotify to play this content.",
  "feedback.video-unsupported-platform-version":
    "This content cannot be played on your operating system version.",
  "feedback.video-country-restricted":
    "We're not able to play this content in your current location.",
  "feedback.video-unavailable": "This content is unavailable. Try another?",
  "feedback.video-catalogue-restricted":
    "Sorry, we're not able to play this content.",
  "feedback.video-playback-error":
    "Sorry, we're not able to play this content.",
  "feedback.video-unsupported-key-system":
    "Hmm... we can't seem to play this content. Try installing the latest version of Spotify.",
  "feedback.explicit-content-filtered":
    "Spotify 当前无法播放此内容，因为该内容包含儿童不宜片段。",
  "feedback.play-after-ad": "已选择的内容将在广告结束后播放",
  "action-trigger.button.not-now": "以后再说",
  close: "关闭",
  login: "登录",
  "web-player.connect.device-picker.premium-required": "需要订阅 Premium",
  "web-player.connect.device-picker.premium-required-tooltip":
    "只有订阅 Premium 后才可在此设备上播放 Spotify",
  "web-player.connect.device-picker.not-installed": "在设备上安装 Spotify",
  "web-player.connect.device-picker.unsupported-uri": "无法播放此曲目",
  "web-player.connect.device-picker.unavailable": "不支持收听",
  "error-page.header.cdmerror": "无法播放受保护内容。",
  "error-page.subtext.cdmerror":
    "访问 Spotify 支持网站，了解如何在浏览器中启用播放功能。",
  "error-page.cta.cdmerror": "Spotify 支持",
  "error-page.header.max_subscriptions_reached": "你打开的选项卡已达上限…",
  "error-page.subtext.max_subscriptions_reached":
    "你打开的选项卡太多了，关闭此选项卡以继续收听。",
  "block-user.dialog.title": "屏蔽 {0}？",
  "block-user.dialog.description":
    "{0} 将无法再查看你的个人资料或关注你，也无法查看你的收听动态。",
  ...
  browser_upgrade_notice:
    "Spotify 已不再支持此版本的 {0}。请更新你的浏览器以获得不受干扰的聆听体验。",
  "offline-error.device-limit-reached.header": "设备数已达上限",
  "offline-error.device-limit-reached.message":
    "删除另一台设备上的所有已下载内容，以便使用此设备离线收听。",
  ...
  "ewg.help": "帮助",
  "ewg.help-text":
    "设置为 100% 时，系统会自动展开播放器以适应手机和桌面设备的布局。",
  "ewg.terms":
    "在网站上嵌入 Spotify 播放器即代表你同意 <a href=\"%devTerms%\" target=\"_blank\">Spotify's Developer Terms</a> 和 <a href=\"%platfRules%\" target=\"_blank\">Spotify 平台规则</a>",
  "ewg.start-at": "开始时间",
  "ewg.showcode": "显示代码",
  ...
  "duplicate.tracks.someAlreadyAddedDescription":
    "其中有些曲目内已在你的 '{0}' 歌单中。",
  ...
  "employee-podcasts.modal.title":
    "These podcasts are meant for Spotify employee ears only.",
  ...
  "leave-playlist.dialog.private-description":
    "这是私人歌单。离开后便无法再访问此歌单。",
  "leave-playlist.dialog.public-contributor-description":
    "离开此歌单后，你将无法向其中添加歌曲。",
  "leave-playlist.dialog.public-listener-description":
    "如果此歌单的拥有者将其设为私人，你将无法访问此歌单。",
  "leave-playlist.dialog.title": "你确定吗？",
  "leave-playlist.dialog.cancel": "以后再说",
  "mwp.d2p.modal.title": "无限畅听音乐",
  "mwp.d2p.modal.description":
    "Premium 让你畅享 Spotify 上的所有音乐，不受广告干扰。随时随地播放歌曲。更可离线畅听。",
  ...
  "midyear.intro":
    "Enjoy ad-free music listening, offline listening, and more. Cancel anytime.",
  "midyear.terms":
    "Monthly subscription fee applies after. Limited eligibility, <a target=\"_blank\" href=\"%help_link%\">terms apply</a>.",
  "view.web-player-home": "主页",
  "navbar.search": "搜索",
  "navbar.your-library": "音乐库",
  "navbar.premium": "Premium",
  "resize.sidebar": "调整导航主页面的大小",
  "premium.dialog.title": "订阅 Spotify Premium",
  "premium.dialog.description":
    "享受无限制音乐、个人化歌单及更多功能。符合条件的成员可免费体验 {0} 个月。",
  "premium.dialog.subscribe": "订阅",
  "user.log-out": "退出",
  "premium.dialog.disclaimer.noprice": "Terms and conditions apply.",
  "premium.dialog.disclaimer":
    "之后 %price%/月。条款与条件适用。对于已使用过 Premium 的用户，一个月免费体验不再适用。",
  ...
  "playlist-radio.header.moreThanThreeFeaturedArtists":
    "Featuring {0, {1, {2} and more.",
  "playlist-radio": "Playlist Radio",
  "song-radio": "Song Radio",
  "album-radio": "Album Radio",
  "artist-radio": "Artist Radio",
  radio: "Radio",
  "error.not_found.title.station": "无法找到该电台",
  "podcasts.episode.seo.title": "%name% - %show%|Spotify 中的播客",
  "error.not_found.title.podcast": "无法找到该播客",
  "podcasts.show.seo.title": "%name%|Spotify 中的播客",
  ...
  "collection.empty-page.episodes-subtitle":
    "点击加号图标以将单集收藏到此歌单。",
  ...
  "collection.page-title": "Spotify – 音乐库",
  "web-player.blend.group-invite.header": "邀请好友",
  "web-player.blend.duo-invite.description":
    "选择要一起创建共享合辑的好友，用歌单展现你们合拍的音乐喜好。",
  "web-player.blend.invite.button-title": "邀请",
  "web-player.blend.group-invite.warning":
    "注意：最多可邀请 10 人。关联的好友将会看到你的个人资料图片和用户名。邀请好友将创建歌单，并使用其他符合你音乐喜好的推荐功能。",
  "web-player.blend.invite.page-title": "创建共享合辑",
  "folder.empty.title": "开始添加歌单",
  "folder.empty.subtitle": "拖放至“歌单”面板即可",
  "downloadPage.page-title": "Spotify – 下载桌面版",
  "download-page.subtext":
    "不间断地收听你喜爱的音乐。下载电脑版 Spotify 应用。",
  "download-page.header": "获取免费应用",
  "concerts.default_location": "你的地点",
  concerts_shows_in: "演出地点：",
  "live_events.label": "现场活动",
  "live_events.disclaimer":
    "Spotify 通过此现场活动中心从门票销售中赚取分销佣金和/或服务费",
  "concert.error.concert_not_found_title": "无法找到你想寻找的演唱会。",
  "i18n.meta.track-lyrics.title.raw": "{0} - 作曲、作词：{1}",
  song: "歌曲",
  ...
  "windowed.product-album-header": "仅限 Premium 用户",
  "windowed.product-album-description":
    "这位艺人要求我们暂时只在 Premium 上发布此专辑，但你不妨过段时间再来看看。",
  "album-page.more-releases": "其他 {0} 首歌曲",
  "album-page.more-by-artist": "更多来自 {0} 的内容",
  "artist-page.show-discography": "查看唱片目录",
  "error.not_found.title.album": "无法找到该专辑",
  "web-player.soundtrap.unpublished-projects.title": "未发布的歌曲",
  "web-player.soundtrap.unpublished-projects.tagline": "仅自己可见",
  "web-player.soundtrap.private-songs.title": "私人歌曲",
  "web-player.soundtrap.private-songs.tagline":
    "只有收到链接的用户能聆听你的歌曲",
  "web-player.soundtrap.public-songs.title": "公开歌曲",
  "web-player.soundtrap.public-songs.tagline":
    "在你的个人资料页面和仅限员工访问的歌单中可见",
  "web-player.soundtrap.error.request-templates-failure":
    "从 Soundtrap 加载模板失败",
  "playlist.similar-playlist": "Similar playlist",
  "browse.made-for-you": "为你打造",
  "browse.charts": "排行榜",
  new_releases: "新歌热播",
  "browse.discover": "发现",
  "browse.live-events": "现场活动",
  "browse.podcasts": "播客",
  ...
  "keyboard.shortcuts.layout.navigationBarDecreaseWidth": "减少导航栏宽度",
  "keyboard.shortcuts.layout.navigationBarIncreaseWidth": "增加导航栏宽度",
  "keyboard.shortcuts.layout.friendFeedDecreaseWidth":
    "减少“好友活动”区域的宽度",
  "keyboard.shortcuts.layout.friendFeedIncreaseWidth":
    "增加“好友活动”区域的宽度",
  ...
  save: "收藏",
  "image-upload.legal-disclaimer":
    "继续下一步，则表示你已同意 Spotify 获取你选择上传的图像。请确保你有上传此图像的权利。",
  "about.title_label": "关于 Spotify",
  "about.copyright":
    "版权所有 © {0} Spotify AB。<br/>Spotify® 是 Spotify 集团的注册商标。",
  "search.title.recent-searches": "最近的搜索记录",
  "search.clear-recent-searches": "清空最近的搜索记录",
  more: "更多",
  "forbidden-page.title": "此歌单不可用",
  "forbidden-page.description":
    "此歌单的所有者已将其设为私人歌单，或已将其从 Spotify 中删除。",
  ...
  "contextmenu.go-to-playlist-radio": "转至歌单电台",
  ...
  "sidebar.collaborative_playlist": "共建歌单",
  playlist: "歌单",
  ...
  "navbar.search.callout-description":
    "Find your favorite artists, podcasts, or songs.",
  "a11y.externalLink": "外部链接",
  "sidebar.playlist_create": "创建歌单",
  "sidebar.liked_songs": "已点赞的歌曲",
  "search.title.all": "全部",
  "search.empty-results-title-for-chip": "未找到“{0}”的 {1}",
  "search.empty-results-title": "未找到“{0}”的相关结果",
  "search.empty-results-text":
    "请确保你的关键字拼写正确，或者使用更少或不同的关键字。",
  "search.see-all": "查看全部",
  "search.search-for-label": "想听什么？",
  "search.a11y.clear-input": "清空搜索栏内容",
  "web-player.soundtrap.navbar.make-music": "创建音乐",
  ...
  "i18n.language-selection.subtitle":
    "这会更新你在 open.spotify.com 上阅读的内容.",
  "web-player.feature-activation-shelf.group-sessions-modal.title":
    "如何创建群组点歌房",
  "web-player.feature-activation-shelf.group-sessions-modal.description-1":
    "群组点歌房让你可与好友随时随地一起聆听音乐和播客。",
  "web-player.feature-activation-shelf.group-sessions-modal.description-2":
    "如要创建群组点歌房：",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-1":
    "请在手机或平板电脑上打开 Spotify。",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-2":
    "挑选一首歌曲或播客，然后播放。",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-3":
    "点击 {icon}。",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-4":
    "点击<b>创建远程群组点歌房</b>。",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-5":
    "点击<b>邀请好友</b>。",
  "web-player.feature-activation-shelf.group-sessions-modal.instruction-6":
    "与你的好友分享此群组点歌房。",
  "web-player.feature-activation-shelf.group-sessions-modal.description-3":
    "你只能使用手机或平板电脑创建或加入群组点歌房。",
  "desktop.settings.storage.downloads.success": "已删除所有下载内容",
  "desktop.settings.storage.downloads.dialog.heading": "删除下载内容？",
  "desktop.settings.storage.downloads.dialog.error":
    "抱歉，我们无法删除下载内容。如果问题仍然存在，请联系支持团队。",
  "desktop.settings.storage.downloads.dialog.text":
    "你将无法再次访问此设备上的下载内容。",
  ...
  "desktop.settings.storage.cache.dialog.error":
    "抱歉，我们无法清除你的缓存。如果问题仍然存在，请联系支持团队。",
  "desktop.settings.storage.cache.dialog.text":
    "Spotify 保存在该设备上的任何临时文件都将被删除。你的下载内容不会受到影响。",
  "desktop.settings.storage.cache.button": "清除缓存",
  "tracklist-header.songs-counter": "{0} 首歌曲",
  "user.public-playlists": "{0} 个公开歌单",
  "user.private-playlists": "{0} 个私人歌单",
  likes: "{0} 次点赞",
  "user.followers": "{0} 位粉丝",
  "user.following": "关注 {0} 人",
  "tracklist-header.episodes-counter": "{0} 个单集",
  "chart.new-entries": "{0} 首新曲目",
  "wrapped.logged_in_and_eligible.description.2022":
    "你可在应用内查看年度总结故事。立即下载年度总结，了解你今年的听歌情况。",
  "wrapped.logged_out_or_eligible.description.2022":
    "年度总结故事仅可在应用内查看。立即下载，一起享受乐趣。",
  "wrapped.ineligible.description.2022":
    "你今年的收听数据似乎还不够多，无法生成年度总结。即刻查看 2022 年内容集锦。",
  ...
  "folder.title": "歌单文件夹",
  albums: "专辑",
  "collection.filter.albums": "在专辑中搜索",
  "error.request-collection-albums-failure": "加载你收藏的专辑时出错。",
  "collection.empty-page.albums-cta": "查找专辑",
  "collection.empty-page.albums-subtitle": "点击心形图标收藏专辑。",
  "collection.empty-page.albums-title": "关注第一张专辑",
  artists: "艺人",
  "collection.filter.artists": "在艺人中搜索",
  "error.request-collection-artists-failure": "加载你关注的艺人时出错。",
  "collection.empty-page.artists-subtitle":
    "点击下面的按钮，关注你喜欢的艺人。",
  "collection.empty-page.artists-title": "关注第一位艺人",
  "collection.empty-page.artists-cta": "查找艺人",
  "search.title.audiobooks": "有声书",
  "collection.empty-page.books-cta": "查找有声书",
  "collection.empty-page.books-subtitle": "点击“收藏”按钮，即可收藏有声书。",
  "collection.empty-page.books-title": "你收藏的有声书将显示在此处",
  playlists: "歌单",
  "collection.filter.playlists": "在歌单中搜索",
  "collection.empty-page.playlists-cta": "创建歌单",
  "collection.empty-page.playlists-title": "创建你的第一个歌单",
  "collection.empty-page.playlists-subtitle": "很简单，我们将助你一臂之力。",
  podcasts: "播客",
  "collection.filter.podcasts": "在播客中搜索",
  "error.request-collection-shows-failure": "加载你的播客时出错。",
  "collection.empty-page.shows-subtitle": "点击“关注”按钮，关注你喜爱的播客。",
  "collection.empty-page.shows-title": "关注第一个播客",
  "error.request-collection-music-downloads-failure": "加载已下载音乐时出错。",
  music_downloads: "音乐下载",
  "concerts.count_near_location": "“{1}”附近的 {0} 场演唱会",
  "concerts.error.no_concerts_found_title":
    "我们无法在你所处的地点找到演唱会。",
  "concerts.error.no_concerts_found_message": "我们无法在 {0} 找到演唱会。",
  concerts_upcoming_virtual_events: "即将举行的虚拟活动",
  concerts_recommended_for_you: "为你推荐",
  concerts_popular_near_you: "你附近的热门活动",
  "error.request-playlist-failure": "加载歌单时出错。",
  "blend.link-invialid.header": "此链接无效",
  "blend.link-invalid.subtitle":
    "邀请他人创建新的共享合辑。你可以拥有不限量的共享合辑。",
  ...
  "queue.next-up": "下一首",
  "blend.invite.body-with-name":
    "{0}邀请你加入 Spotify 上的共享合辑。可在 Spotify 移动版应用上加入。{1}",
  "blend.invite.body-without-name":
    "邀请你加入 Spotify 上的共享合辑。可在 Spotify 移动版应用上加入。{0}",
  "contextmenu.go-to-song-radio": "转至歌曲电台",
  "contextmenu.show-credits": "显示提供者",
  "context-menu.copy-track-link": "复制歌曲链接",
  "track-page.sign-in-to-view-lyrics": "登录后即可查看歌词并收听完整曲目",
  episodes: "单曲",
  followers: "粉丝",
  following: "关注中",
  ...
  "web-player.album.anniversary":
    "\"%name%\" was released %years% years ago this week!",
  ...
  "web-player.soundtrap.projects-tracklist.aria": "项目曲目列表",
  "web-player.soundtrap.title": "创建音乐",
  "web-player.soundtrap.subtitle.text":
    "Create and publish songs right on Spotify. Choose a song and genre, record your vocals, then edit the song to make it yours.",
  "web-player.soundtrap.confidential":
    "This is a highly confidential test. Do not share details of this test or any song you create outside of Spotify.",
  "web-player.soundtrap.subtitle.link":
    "<p>在你的<a href=\"{0}\">个人资料页面</a>查看你已发布和未发布的歌曲。</p>",
  browse: "浏览",
  ...
  "pick-and-shuffle.upsell.title.shuffle-button": "订阅 Premium，按顺序播放",
  ...
  "playlist.edit-details.error.description-breaks": "简介中不支持换行符。",
  "playlist.edit-details.error.invalid-html": "歌单简介不支持 HTML。",
  "playlist.edit-details.error.unsaved-changes":
    "点击“保存”以储存你所作出的修改。",
  "playlist.edit-details.error.no-internet":
    "无网络连接。无法保存对简介和图像的更改。",
  "playlist.edit-details.error.file-size-exceeded":
    "图像太大。请选择 {0}MB 以下的图像。",
  "playlist.edit-details.error.too-small":
    "图像太小。图像分辨率至少为 {0}x{1}。",
  "playlist.edit-details.error.file-upload-failed":
    "无法上传图像。请再试一次。",
  "playlist.edit-details.error.missing-name": "歌单名称是必填项。",
  "playlist.edit-details.error.failed-to-save":
    "无法保存歌单更改内容。请再试一次。",
  "playlist.edit-details.change-photo": "更改照片",
  "playlist.edit-details.remove-photo": "删除照片",
  edit_photo: "编辑照片",
  "playlist.edit-details.description-label": "简介",
  "playlist.edit-details.description-placeholder": "添加说明（可选）",
  ...
  "playback-control.ban": "删除",
  "video-player.video-not-available": "仅下载视频播客的音频",
  "video-player.show-video": "显示视频",
  "video-player.hide-video": "隐藏视频",
  npb_pip_web_player: "画中画",
  "pta.bottom-bar.title": "预览 Spotify",
  "fta.bottom-bar.subtitle":
    "注册后无限畅听各式歌曲和播客（偶尔会有广告）。无需使用信用卡。",
  "fta.sign-up-free": "免费注册",
  "fta.bottom-bar.subtitle-two":
    "Listen to local favorites and the world’s best playlists.",
  "my.headline":
    "Try Premium free for 3 months. Listen to your music offline and ad-free. Monthly subscription fee applies after. Open only to users who haven't already tried Premium. Offer excludes Family and Duo plans. <a href=\"%help_link%\">Terms and conditions apply</a>.",
  "age.restriction.explicitContent":
    "你必须年满 19 岁，才能收听儿童不宜内容，其标志为：",
  ...
  "web-player.enhance.button_aria_label_enhanced": "关闭“升级至高级版”功能",
  "web-player.enhance.button_aria_label_not_enhanced": "开启“升级至高级版”功能",
  "web-player.enhance.button_text_enhanced": "高级版",
  "web-player.enhance.button_text_not_enhanced": "升级至高级版",
  "web-player.enhance.onboarding.enhance-playlist":
    "将歌单升级至高级版，即可获取每日更新的推荐歌曲。",
  "web-player.enhance.missing-functionality-callout.filtering-playlist-disabled-title":
    "筛选已禁用",
  "web-player.enhance.missing-functionality-callout.filtering-playlist-disabled-message":
    "歌单升级至高级版时，筛选将禁用。关闭“升级至高级版”功能以像往常一样筛选。",
  "web-player.enhance.missing-functionality-callout.sorting-playlist-disabled-title":
    "排序已禁用",
  "web-player.enhance.missing-functionality-callout.sorting-playlist-disabled-message":
    "歌单升级至高级版时，排序选项将禁用。关闭“升级至高级版”功能以像往常一样排序。",
  ...
  "playlist.remove_multiple_description":
    "如果你改变主意了，则需要重新添加这些曲目。",
  "playlist.delete-cancel": "取消",
  "tracklist.drag.multiple.label": "{0} 个项目",
  ...
  "web-player.nav-alt-onboarding.nav-bar.title": "浏览你的最爱",
  "web-player.nav-alt-onboarding.nav-bar.description":
    "你可在这里查看你收藏的歌曲、歌单和单集。",
  "web-player.nav-alt-onboarding.nav-bar.dismiss": "撤销",
  "web-player.nav-alt-onboarding.nav-bar.next": "下一步",
  "web-player.nav-alt-onboarding.fixed-top-bar.title": "发现新内容",
  "web-player.nav-alt-onboarding.fixed-top-bar.description":
    "我们已将“主页”和“搜索”功能移至这里，方便你使用。",
  "web-player.nav-alt-onboarding.fixed-top-bar.back": "返回",
  "web-player.nav-alt-onboarding.fixed-top-bar.done": "完成",
  ...
  "offline.callout-disconnected":
    "请确认你已在线。唯有在已连接网络的情况下，Spotify 才能有最佳表现。",
  "offline.badge": "你已离线",
  "private-session.callout": "你正在私人点歌房中匿名收听。",
  ...
  "web-player.search-modal.a11y.contentbyartist":
    "%creator% 的 %item%（%type%）",
  ...
  "episode.sponsored_by": "赞助人",
  "i18n.language-selection.cookie-settings":
    "如要选择语言，则必须更改 Cookie 设置。",
  "i18n.language-selection.learn-more-here": "在此处了解更多。",
  "card.tag.genre": "曲风",
  "episode.length": "{0} 分钟",
  "card.tag.episode": "单集",
  ...
  "desktop.settings.localAutoplayInfo":
    "当音乐结束时在此应用上自动播放相似歌曲",
  "desktop.settings.globalAutoplayInfo":
    "当音乐在其他设备上结束时自动播放相似歌曲",
  "desktop.settings.autoplayInfo":
    "纵享不间断畅听体验。在当前音频结束时，我们会为你播放相似内容",
  "settings.display": "显示",
  ...
  "web-player.feature-activation-shelf.audio_quality_toast_message":
    "你的音质已更改为“超高”",
  ...
  "desktop.settings.automatic-downgrade.info":
    "我们会在网络带宽速度缓慢时为你调整音质。关闭此功能可能会导致你的聆听中断。",
  "desktop.settings.normalize": "标准音量 - 为所有歌曲和播客设置相同的播放音量",
  "desktop.settings.loudnessEnvironment_with_limiter_details":
    "音量 - 根据你所在的环境调整音量。高音量可能会降低音质。“标准”或“安静”模式下音质不受影响。",
  ...
  "desktop.settings.publishTopArtists":
    "在公开个人资料上显示我最近听过其作品的艺人",
  "episode.sponsors": "单集赞助商",
  "desktop.settings.settings": "设置",
  "settings.employee": "仅限员工",
  "desktop.settings.language-override":
    "Override certain user attributes to test regionalized content programming. The overrides are only active in this app.",
  "desktop.settings.enableDeveloperMode": "启用开发者模式",
  "desktop.settings.language": "语言",
  "desktop.settings.selectLanguage": "选择语言 - 改动将在重启应用时就绪",
  "web.settings.systemDefaultLanguage": "系统默认语言",
  "desktop.settings.playback": "播放",
  "ad-formats.exclusive": "Spotify 独家版权",
  ...
  "action-trigger.listen-mixed-media-episode":
    "你可立即在 Spotify 应用中收听此单集。",
  "action-trigger.button.get-app": "获取应用",
  "web-player.episode.transcript.disclaimer":
    "此文字记录自动生成，其准确性无法保证。",
  ...
  "paywalls.modal-body-p2":
    "你可以独家享受节目内容，包括创作者发布的所有额外单集。",
  "paywalls.modal-body-p3":
    "欢迎查看节目注释，或通过访问创作者的网站了解更多信息。",
  "episode.played": "已播",
  ...
  "web-player.audiobooks.chapter": "章节",
  "web-player.audiobooks.seeAllChapters": "查看所有章节",
  ...
  "web-player.folder.playlists": "{0} 个歌单",
  "web-player.folder.folders": "{0} 个文件夹",
  ...
  "concert.header.upcoming_concert_title_more":
    "{0}、{1}、{2} 和 {3}，及更多艺人…",
  ...
  "queue.confirm-title": "是否将这些内容从队列中清除？",
  "queue.confirm-message": "此操作无法撤销",
  "queue.confirm-button": "是",
  "concert.header.tickets_from_1": "{0} 正在销售门票",
  "concert.header.tickets_from_2": "{0} 和 {1} 正在销售门票",
  "concert.header.tickets_from_3": "{0}、{1} 和 {2} 正在销售门票",
  "concert.header.tickets_from_4": "{0}、{1}、{2} 和 {3} 等渠道正在销售门票",
  concert_event_ended: "活动已结束",
  concert_past_message: "查看更多即将开展的活动，获取更多精选推荐",
  "concert.header.available_tickets_from": "售票渠道",
  concerts_more_events: "更多你可能喜欢的活动",
  "view.see-all": "查看全部",
  ...
  discovered_on: "含有此歌曲的歌单",
  "rich-page.fans-also-like": "粉丝也喜欢",
  "artist-page.world_rank": "世界排名",
  "artist.monthly-listeners-count": "每月有 {0} 名听众",
  monthly_listeners: "每月听众",
  "artist-page.where-people-listen-from": "{0}，{1}",
  "artist-page.how-many-listeners": "{0} 名听众",
  ...
  "artist-page.saved-tracks-amount": "你已为 {0} 首歌曲点赞",
  "artist-page.saved-by-artist": "创建者：{0}",
  "web-player.soundtrap.publishing-in-progress.label": "正在发布",
  "web-player.soundtrap.context-menu.make-private": "设为私人",
  "web-player.soundtrap.context-menu.make-public": "设为公开",
  "playback-control.a11y.lightsaber-hilt-button":
    "Toggle lightsaber hilt. Current is {0}.",
  ...
  "pick-and-shuffle.upsell.message":
    "订阅 Premium，不用再随机播放，还可离线无广告畅听音乐",
  ...
  "time.days.long": "{0} 天",
  "time.hours.long": "{0} 小时",
  "time.minutes.long": "{0} 分钟",
  "my.offer_ends_in": "优惠截止剩余时间",
  "npv.full-screen": "全屏",
  "buddy-feed.friend-activity": "好友活动",
  "playlist.presented_by": "由 {0} 赞助",
  "web-player.connect.bar.connected-state": "正在 %device_name% 上收听",
  "web-player.connect.bar.connecting-state": "正在连接“%device_name%”",
  "web-player.enhance.contextmenu.turn-off-enhance": "关闭“升级至高级版”功能",
  "web-player.enhance.contextmenu.turn-on-enhance": "开启“升级至高级版”功能",
  "web-player.enhance.missing-functionality-callout.dismiss": "撤销",
  "web-player.enhance.missing-functionality-callout.turn-off-enhance":
    "关闭“升级至高级版”功能",
  "contextmenu.create-playlist": "创建歌单",
  "context-menu.copy-spotify-uri": "复制 Spotify 链接",
  "contextmenu.open_desktop_app": "在桌面应用中打开",
  "context-menu.profile": "查看个人资料",
  ...
  "permissions.songs-added": "已添加 {0} 首歌曲",
  "npb.collapseCoverArt": "折叠",
  "search.a11y.songs-search-results": "歌曲搜索结果",
  "time.hours.short": "{0} 小时",
  "time.minutes.short": "{0} 分钟",
  "time.seconds.short": "{0} 秒",
  "user.account": "帐号",
  ...
  "desktop.settings.cookiesDisabled":
    "阻止安装 Spotify 桌面应用时产生的所有 Cookie，在<a class=\"settings__cookiesDiabled-link\" href=\"https://www.spotify.com/legal/privacy-policy/\">隐私政策</a>中了解更多详情。改动将在重启应用时就绪",
  ...
  "desktop.settings.storage.cache.text":
    "Spotify 为在慢速网络下保持流畅播放体验而存储的临时文件",
  ...
  "carousel.left": "上一首",
  "carousel.right": "下一首",
  "context-menu.copy-chapter-link": "复制章节链接",
  ...
  "audiobook.freePriceExplanation":
    "点击“获取”将此有声书添加到“音乐库”，几秒后即可收听。",
  "web-player.audiobooks.retailPrice": "零售价",
  ...
  "web-player.audiobooks.rating.goToApp":
    "在手机上打开 Spotify，评价这本有声书。",
  ...
  "user.edit-details.error.file-size-exceeded":
    "图像太大。请选择 {0}MB 以下的图像。",
  ...
  "web-player.soundtrap.publishing-modal.aria": "Soundtrap 歌曲发布模式",
  "web-player.soundtrap.publishing-modal.title": "你的歌曲正在发布",
  "web-player.soundtrap.publishing-modal.description":
    "发布歌曲通常需要 10 分钟。歌曲发布后，你便可将其与任何 Spotify 员工分享。",
  "pwa.understood": "好的",
  ...
  "web-player.hifi.aria-label": "HiFi 音频体验",
  "web-player.enhance.button_label_keep_in_playlist": "存入歌单",
  "web-player.enhance.onboarding.add-recommendation-to-playlist":
    "喜欢这首歌曲吗？赶快加入歌单！",
  "web-player.enhance.button_label_remove_from_playlist": "从歌单中删除",
  ...
  "search.row.subtitle": "有声书",
  "sidebar.expand_folder": "展开文件夹",
  playing: "正在播放",
  "buddy-feed.add-friends": "添加好友",
  "buddy-feed.find-friends": "寻找好友",
  ...
  "web-player.your-library-x.empty-state-podcasts-to-follow":
    "不妨关注一些播客",
  ...
  "web-player.your-library-x.empty-results-title-short": "Couldn't find \"{0}\"",
  "web-player.your-library-x.empty-results-text-short":
    "请尝试使用其他拼写或关键字再次搜索。",
  "web-player.your-library-x.your-library": "Your Library",
  "web-player.your-library-x.search-text-field-placeholder":
    "Search Your Library",
  ...
  "tracklist.header.plays": "播放次数",
  "tracklist.header.added-by": "添加者：",
  "tracklist.header.date-added": "添加日期",
  "tracklist.header.release-date": "发售日期",
  ...
  "concerts.count": "{0} 场演唱会",
  "concert.label.headliner": "知名艺人",
  "artist.concerts.error.not_found": "此艺人无演唱会行程。",
  ...
  "buddy-feed.facebook.connect-with-friends-default":
    "关联 Facebook 帐号以查看好友收听内容。",
  "buddy-feed.facebook.button": "关联 Facebook 帐号",
  "buddy-feed.facebook.disclaimer":
    "未得到你的许可，我们不会发布任何内容。在设置中显示和隐藏好友活动。",
  "buddy-feed.let-followers-see-your-listening":
    "让 Spotify 上的朋友与粉丝查看你在收听的内容。",
  "buddy-feed.enable-share-listening-activity":
    "前往“设置”>“隐私设置”，并启用“在 Spotify 分享我的收听动态”。你可以随时关闭此功能。",
  "web-player.your-library-x.create.button-label": "Create",
  "buddy-feed.close": "关闭",
  "equalizer.filterA11yValueText": "{0}dB",
  "equalizer.filterLabel": "{0}Hz 时改变分贝",
  "web-player.feature-activation-shelf.title": "探索 Premium",
  ...
  "web-player.audiobooks.chapterUpsell.title":
    "喜欢这本有声书吗？请先解锁所有章节",
  "web-player.audiobooks.chapterUpsell.description":
    "购买完整有声书后，即可聆听此章节。",
  "web-player.audiobooks.chapterUpsell.cta": "购买有声书",
  ...
  "hifi.connectExplanation":
    "Spotify Connect 是聆听 HiFi 音乐的绝佳方式。只需播放歌曲，然后点击屏幕底部的 {0} 查找 {1} 兼容设备，并直接通过应用控制音乐。",
  "spotify-connect": "Spotify Connect",
  "hifi.changeCellularSettings":
    "你已在“设置”中完成设置，将串流播放“极高”或更低音质的音乐。如要更改此设置，请前往“<a href=\"spotify:app:preferences\">设置</a>”，并将“串流播放品质”选成“HiFi”。",
  "hifi.optOutOfDowngrade":
    "你已在“设置”中禁用自动调整音质功能。这意味着，网络带宽不足时，你的聆听体验可能会受到干扰。",
  "hifi.poorBandwidthInterferes":
    "似乎你的网络带宽当前无法支持 HiFi 音乐。请尝试检查网络连接，或更换其他网络。",
  "hifi.defaultToVeryHigh":
    "没什么比刚沉浸在歌曲中，歌曲却突然跳过更恼人了。因此当你带宽不佳时，我们会自动将你的音质从“HiFi”调整为较低的音质。",
  "hifi.needToReDownload":
    "已下载的歌曲当前不支持 HiFi 音质。如要收听 HiFi 音乐，请尝试重新下载。请留意，HiFi 歌曲文件较大，可能会占用大量存储空间。",
  "hifi.bluetoothDegradesHifi":
    "比起单独使用 Spotify Premium，配合蓝牙聆听 HiFi 音乐能享受更高音质。要尽享 HiFi 音质，最好的方式是通过 {0} Spotify Connect 扬声器和/或有线设备聆听。",
  "hifi.songNotAvailableTitle": "Song not available",
  "hifi.songNotAvailable":
    "The song you're trying to listen to is not available in HiFi at this time.",
  "buddy-feed.number-of-friends": "你在 Spotify 上有 {0} 位好友。",
  "buddy-feed.find-in-playlists": "按名字筛选",
  "web-player.buddy-feed.connect-with-facebook-title": "关联 Facebook 帐号？",
  "web-player.buddy-feed.connect-with-facebook-description":
    "与 Spotify 分享你的 Facebook 网名、个人资料图片和好友列表，以便在 Spotify 上找到 Facebook 好友。",
  "web-player.buddy-feed.connect-button": "关联",
  "web-player.your-library-x.create.create-a-new-playlist":
    "Create a new playlist",
  "web-player.your-library-x.create.create-a-playlist-folder":
  ...
  "web-player.your-library-x.rows.folder.number-of-playlists": "{0} playlists",
  "web-player.your-library-x.rows.folder.number-of-folders": "{0} folders",
  "web-player.your-library-x.type-playlist": "Playlist",
  "web-player.your-library-x.rows.liked-songs.subtitle": "{0} songs",
  "web-player.your-library-x.rows.local-files.subtitle": "{0} tracks",
  "web-player.your-library-x.type-show": "Podcast",
  "web-player.your-library-x.subtitle-your-episodes":
    "Saved & downloaded episodes",
  "web-player.feature-activation-shelf.enhance-placeholder.title":
    "订阅 Premium，将你的歌单升级至高级版",
  "web-player.feature-activation-shelf.enhance.description":
    "即刻添加符合此歌单独特品味的个性化曲目",
  "web-player.feature-activation-shelf.enhance-placeholder.cta": "了解更多",
  "web-player.feature-activation-shelf.enhance.title":
    "将 %playlist% 升级至高级版",
  "web-player.feature-activation-shelf.enhance.cta-enhanced": "高级版",
  "web-player.feature-activation-shelf.enhance.cta": "升级至高级版",
  "web-player.feature-activation-shelf.group-sessions.title":
    "随时随地一起畅听",
  "web-player.feature-activation-shelf.group-sessions.description":
    "邀请好友和你一起远程控制播放内容",
  "web-player.feature-activation-shelf.group-sessions.cta": "了解更多",
  "web-player.feature-activation-shelf.audio-quality.title":
    "启用更高音质的音频",
  "web-player.feature-activation-shelf.audio-quality.description":
    "你将以卓越音质聆听通透清脆的高音和低沉洪亮的低音",
  ...
  "web-player.connect.device-picker.check-wifi-subtitle":
    "将你正在使用的设备连接至同一个 WiFi。",
  "web-player.connect.device-picker.play-from-another": "在其他设备上播放",
  "web-player.connect.device-picker.play-from-another-subtitle":
    "相关信息将自动显示在这里。",
  "web-player.connect.device-picker.restart-speaker": "重启扬声器",
  "web-player.connect.device-picker.restart-speaker-subtitle":
    "如果是新设备，请遵循设置说明。",
  "web-player.connect.device-picker.switch-to-app": "切换至 Spotify 应用",
  "web-player.connect.device-picker.switch-to-app-subtitle":
    "此应用可以检测更多设备。",
  "connect-picker.this-computer": "此电脑",
  "connect-picker.this-web-browser": "此网页浏览器",
  "connect-picker.listening-on": "收听设备",
  "hifi.networkConnection": "Network connection",
  "hifi.good": "Good",
  "hifi.poor": "Poor",
  "hifi.unknown": "未知",
  "hifi.hifiCompatibleDevice": "HiFi 兼容设备",
  "hifi.yes": "Yes",
  "hifi.no": "No",
  ...
  "time.now": "立即",
  "web-player.your-library-x.pinned": "Pinned",
  ...
  "time.weeks.short": "{0} 周",
  "time.days.short": "{0} 天",
  "web-player.connect.nudge.connect-to-device": "在此处关联设备",
  "web-player.connect.nudge.listen-to-device": "使用其他设备聆听",
